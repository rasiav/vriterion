local vriterion = Instance.new("ScreenGui")
...
vriterion.Name = "vriterion"
vriterion.Parent = game.CoreGui
vriterion.ZIndexBehavior = Enum.ZIndexBehavior.Sibling

Open.Name = "Open"
Open.Parent = vriterion
...
UIstro.Name = "UIstro"
 ...
 UIstro.Color = Color3.fromRGB(51,255,255)
 UIstro.LineJoinMode = Enum.LineJoinMode.Round
 UIstro.Thickness = 1
 UIstro.Transparency = 0
 UIstro.Enabled = true
 UIstro.Archivable = true
...
return Label1func
 ...
 --------------------------------------------------------------------
 local Library = Update:Window("vriterium");
 --------------------------------------------------------------------
...
function TP(P1)
    ...
    --------------------------------------------------------------------
    local Library = Update:Window("vriterion");
    --------------------------------------------------------------------
...
Setting:Seperator("「 Credits 」")
    Setting:Label("Made By jhrenz ")
    Setting:Label("Ui Remade By rasiav")
...
Update:Notification("Hello, "  ..game.Players.LocalPlayer.DisplayName.. " Welcome vriterion V2! What's new? | [+] New Ui [+] New Functions [+] Fix Some Bugs [+] Optimise Script [+] Much More... ")
    ...
    CastleUIstroMansion = CFrame.new(-5084.8447265625, 316.48101806641, -3145.3752441406)
        ...
        while wait() do
            pcall(function()
                if _G.UnlockPortal == true then
                    ...
                    Castletophydra = CFrame.new(-5095.33984375, 316.48101806641, -3168.3134765625)
                    HydratoCastle = CFrame.new(5741.869140625, 611.94750976562, -282.61154174805)
                    if (CastleUIstroMansion.Position - game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 8 then
